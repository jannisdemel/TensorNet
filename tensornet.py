...
class TensorNet(nn.Module):
    ...
    def forward(self, batch_input):
        ...
        if self.static_shapes:
            ...
            # The next two lines are commented because as far as I can see they do not do anything, but they are for some reason part of the origonal code implementation
